...
function setList(list){
	var table = '<thead><tr><td>Descrição</td><td>Qualidade</td><td>Valor</td><td>Ação</td></tr></thead><tbody>';
	for(var key in list){
...
function validation(){
	...
	if(value === ""){
		...
		errors += '<p>Preencha com valor válido</p>';
	}
